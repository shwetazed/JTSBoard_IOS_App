...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    customColorView.backgroundColor = [UIColor colorWithRed:200/255.0
                                                      green:200/255.0
                                                       blue:200/255.0
                                                      alpha:0.5];
    cell.selectedBackgroundView =  customColorView; // shweta
...
- (void)reloadDataForCell:(FSCalendarCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
   ...
   // cell.subtitle  = [self.dataSourceProxy calendar:self subtitleForDate:date];
    cell.eventList = [self.dataSourceProxy calendar:self subtitleListForDate:date];
