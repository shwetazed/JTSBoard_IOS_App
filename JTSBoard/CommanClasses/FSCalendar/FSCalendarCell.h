...
@property (weak, nonatomic) UILabel  *lblEventCounter;

@property (weak, nonatomic) UILabel  *subtitleLabel;
@property (weak, nonatomic) UILabel  *subtitleLabel1;

@property (weak, nonatomic) UILabel  *subtitleLabel2;
@property (weak, nonatomic) UILabel  *subtitleLabel3;
@property (weak, nonatomic) UILabel  *subtitleLabel4;

@property (weak, nonatomic) UIImageView  *imgEventCounter;
